...
# from user_input.forms import Daily_User_Input_StrongForm,\
#                              Daily_User_Input_EncouragedForm,\
#                              Daily_User_Input_OptionalForm,\
#                              Inputs_Changes_from_Third_SourcesForm,\
#                              Goals_Form
...
#         Goals_form = Goals_Form(data = request.POST)

#         if Daily_User_Input_Strong_form.is_valid() and\
#            Daily_User_Input_Encourage_form.is_valid() and \
#            Daily_User_Input_Optional_form.is_valid() and \
#            Inputs_Changes_from_Third_Sources_forms.is_valid() and\
#            Goals_form.is_valid():
...
#             print(Daily_User_Input_Strong_form.errors,\
#                 Daily_User_Input_Encourage_form.errors,\
#                 Daily_User_Input_Optional_form.errors,\
#                 Inputs_Changes_from_Third_Sources_forms.errors,Goals_form.errors)
#     else:
