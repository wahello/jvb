...
def receive_token(request):
    ...
    r = session.request('GET','https://healthapi.garmin.com/wellness-api/rest/dailies?uploadStartTimeInSeconds=1452470400&uploadEndTimeInSeconds=1502150488', header_auth=True)
    print(r.json())
