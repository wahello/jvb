...
def export_users_xls(request):
	...
	col_num2 = 37
	a = len(rows) + len(rows3) + len(rows4)
	...
	col_num2 = 42
	a = len(rows) + len(rows3) + len(rows4) + len(rows5)
	...
	col_num2 = 46
	a = len(rows) + len(rows3) + len(rows4) + len(rows5) + len(rows6)
	...
	col_num2 = 50
	a = len(rows) + len(rows3) + len(rows4) + len(rows5) + len(rows6) + len(rows1)
