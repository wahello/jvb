						...
						<Modal id="modal_stye" isOpen={this.state.modal} backdrop={this.state.backdrop} toggle={this.toggle} style={{ maxWidth: '52%' }}>
				          ...
				          <p id="text_style" style={{marginLeft:'52px'}}>We reserve the right, at our sole discretion, to change, modify, terminate or otherwise alter these Terms and conditions at any time and without prior notice. If we change these Terms, we will inform you by posting the revised Terms to the site with the revised date that they become effective. By continuing to access or use the site or services, you agree to the revised Terms.   </p>
				           ...
				           <p id="sub-heading" style={{fontWeight:'bold' ,fontSize:'20px'}}>CONTENT   </p>
				             ...
				             <p id="text_style" style={{marginLeft:'52px'}}>The Services may allow you to post, upload, transmit, or otherwise make available and provide Content on the Site, including, without limitation, workout and other data (including personal data), or other materials.   </p>
				              <p id="text_style" style={{marginLeft:'52px'}}> Ownership of Your Content. We do not claim ownership rights in your Content. Subject to the non-exclusive license contained in the following paragraph, you own and will retain any and all intellectual property rights that you may have in your Content.  </p>
				                <p id="text_style" style={{marginLeft:'52px'}}>License to Use Your Content. By posting your Content on or through the Site, you hereby grant us a non-exclusive, fully-paid, royalty-free, perpetual, irrevocable, worldwide license to use or sublicense, copy, modify, translate, reproduce, publicly perform, publicly display, distribute, and create derivative works based on your Content in any online or printed form. You consent to our use and disclosure of your Content as set forth in these Terms of Use, including our Privacy Policy.   </p>
				                  <p id="text_style" style={{marginLeft:'52px'}}>You are entirely responsible for all Content that you post, upload, or otherwise make available via the Services.   </p>
				                    <p id="text_style" style={{marginLeft:'52px'}}>You agree that under no circumstances will JVB Health & Wellness be liable in any way for any Content or for any loss or damage of any kind incurred as a result of the use of any Content posted, uploaded or otherwise made available via the Services.   </p>
				             <p id="text_style" style={{marginLeft:'52px'}}>You acknowledge that JVB Health & Wellness shall have the right (but not the obligation) in its sole discretion to refuse, delete or move any Content that is available via the Services, for violating the letter or spirit of the Terms or for any other reason.   </p>
                                        


				           <p id="sub-heading" style={{fontWeight:'bold' ,fontSize:'20px'}}>USER CONDUCT   </p>

				             <p id="text_style" style={{marginLeft:'52px'}}>As a condition of use, you promise not to use the Services for any purpose that is unlawful or prohibited by these Terms of Use, or any other purpose not reasonably intended by JVB Health & Wellness.   </p>
				          
                              <p id="text_style" style={{marginLeft:'52px'}}>By way of example, and not as a limitation, you agree not to use the Services:   </p>

				          
				             <p id="text_style" style={{marginLeft:'48px'}}>1.&nbsp;&nbsp; To be obnoxious, more specifically to abuse, harass, threaten, impersonate or intimidate other JVB Health & Wellness users   </p>
				           
                             <p id="text_style" style={{marginLeft:'48px'}}>2.&nbsp;&nbsp;To contribute any Content that is infringing, libelous, defamatory, obscene, pornographic, abusive, offensive or otherwise violates any law or right of any third party  </p>
                             <p id="text_style" style={{marginLeft:'48px'}}>3.&nbsp;&nbsp;For any illegal or unauthorized purpose. If you are an international user, you agree to comply with all local laws regarding online conduct and acceptable content  </p>
                             <p id="text_style" style={{marginLeft:'48px'}}>4.&nbsp;&nbsp;To post or transmit, or cause to be posted or transmitted, any communication or solicitation designed or intended to obtain password, account, or private information from any JVB Health & Wellness user  </p>
